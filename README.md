...
| **프로필 보정** | 팬·팔로워·참여 키워드 **개수** 등 | **`refreshInfluencerProfile`** — 상세 API·`/my`·대시보드 요청 시, **한국시간(KST) 0·6·12·18시를 나누는 6시간 창마다 최대 1회** (마지막 `updated_at`이 속한 창과 같으면 스킵). 키워드 **별 순위 전체**와는 역할이 다름. |
