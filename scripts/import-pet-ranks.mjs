/**
 * 동물/펫 공식 인플루언서 순위 임포트 (XLSX 파일)
 *
 * 사용법: node scripts/import-pet-ranks.mjs
 */
...
// xlsx 파일 읽기
const filePath = '/Users/orange/Downloads/네이버_동물펫_인플루언서_리스트.xlsx';
