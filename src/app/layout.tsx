...
const FAQ_JSONLD = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: '키워드 검색, 연도별 선정 현황, 커뮤니티는 회원가입 없이 무료로 이용할 수 있습니다. MY 블로그·네이버 메이트 등 무료 기능은 회원가입하면 횟수 제한 없이 이용할 수 있습니다. N인플 AI 대화와 블로그 기본 분석은 비회원 하루 3회, 회원 하루 10회까지 무료이며, 그 밖의 기능은 이용권을 구매하면 됩니다.',
      },
    },
    {
      '@type': 'Question',
