...
const FAQS = [
  {
    ...
    a: '네, 회원가입 후 인플루언서홈 또는 블로그 주소를 연결하면 바로 내 키워드 순위를 확인할 수 있습니다. 가입 없이도 AI 추천 등 일부 기능은 하루 3회까지 무료로 체험해볼 수 있어요.',
  },
  {
    q: '모든 기능이 무료인가요?',
    a: '인플루언서 리스트·검색량 조회·URL 분석 등 핵심 도구는 누구나 무료로 이용할 수 있습니다. 내 키워드 순위 추적·경쟁자 분석·맞춤법 검사·제목 생성 같은 기능은 블로거 플랜(월 5,500원)부터, 키워드 챌린지·블로그 글 피드백 같은 심층 기능은 인플루언서 플랜(월 9,900원)에서 이용할 수 있습니다.',
  },
  {
    q: '데이터는 어떻게 수집되나요?',
