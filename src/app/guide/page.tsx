...
const FAQS = [
  ...
  {
    q: '모든 기능이 무료인가요?',
    a: '인플루언서 리스트·검색량 조회·URL 분석 등 핵심 도구는 누구나 무료로 이용할 수 있습니다. 내 키워드 순위 추적·경쟁자 분석·맞춤법 검사·블로그 글 피드백 같은 심층 기능은 블로거 플랜(월 5,500원) 또는 인플루언서 플랜(월 9,900원)에서 이용 가능합니다. 가입 전 3일 데모 체험으로 먼저 써본 뒤 결정하세요.',
  },
  {
    q: '데이터는 어떻게 수집되나요?',
