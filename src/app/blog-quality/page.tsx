...
export const metadata = {
  title: '블로그 품질지수 (무료) — N인플',
  description: '네이버 블로그의 품질지수를 무료로 확인하세요. C-rank · D.I.A. · D.I.A.+ 종합 결과 기반 추정치.',
};
    ...
    <div className="max-w-3xl mx-auto px-4 py-8 space-y-6">
      <div>
        ...
        <p className="text-sm text-dim mt-1">
          무료로 블로그 품질지수를 확인하세요. 최근 포스트의 검색 노출을 측정해 C-rank · D.I.A. · D.I.A.+ 종합 결과를 근사합니다.
        </p>
      </div>
