    ...
    <div className="space-y-4">
      ...
      >
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
          ...
          <div className="h-[136px] flex flex-col bg-surface rounded-2xl border border-border p-4 shadow-xs transition-all duration-500 ease-out hover:-translate-y-0.5 hover:shadow-lg hover:border-down/40">
            <div className="flex items-start justify-between mb-2 shrink-0">
              <div className="w-7 h-7 rounded-full bg-[#FAF4F2] text-down flex items-center justify-center shrink-0">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M17.94 17.94A10.07 10.07 0 0112 20c-7 0-11-8-11-8a18.45 18.45 0 015.06-5.94M9.9 4.24A9.12 9.12 0 0112 4c7 0 11 8 11 8a18.5 18.5 0 01-2.16 3.19m-6.72-1.07a3 3 0 11-4.24-4.24"/><line x1="1" y1="1" x2="23" y2="23"/></svg>
              </div>
            </div>
            <p className="stat-title mb-0.5 shrink-0">미노출</p>
            ...
            <div className="mt-auto flex items-baseline gap-1.5 pt-1.5 shrink-0">
          ...
          <div className="h-[136px] flex flex-col bg-surface rounded-2xl border border-border p-4 shadow-xs transition-all duration-500 ease-out hover:-translate-y-0.5 hover:shadow-lg hover:border-down/40">
            ...
            <p className="stat-title mb-0.5 shrink-0">누락율</p>
