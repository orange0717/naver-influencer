  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        {/* 누락율 — 슬라이스 탭 */}
        <div className="h-48 flex flex-col bg-surface rounded-[20px] border border-border p-6 shadow-[0_1px_3px_rgba(0,0,0,0.04)] transition-all duration-500 ease-out">
