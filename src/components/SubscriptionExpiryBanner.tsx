        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-sm font-bold text-text">
              구독이 <span className="text-down">{expiredDays}일 전 만료</span>되었습니다
            </p>
            <p className="text-[11px] text-dim">현재 무료 플랜으로 이용 중. 갱신하면 유료 기능을 다시 사용할 수 있습니다.</p>
          </div>
        </div>
        <Link
          href="/subscribe"
  ...
  return (
    <div className="bg-gradient-to-r from-accent/10 to-accent/5 rounded-xl border border-accent/30 px-5 py-3 flex items-center justify-between mb-4 gap-3">
      <div className="flex items-center gap-3">
        ...
        <div>
          <p className="text-sm font-bold text-text">
            구독 만료 <span className="text-accent">{daysLeft}일 남음</span>
          </p>
          <p className="text-[11px] text-dim">미리 갱신하면 끊김 없이 계속 이용할 수 있습니다.</p>
        </div>
      </div>
      <Link
        href="/subscribe"
