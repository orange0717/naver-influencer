  ...
  return (
    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-surface border border-border rounded-xl p-4">
      ...
      <a
        ...
        className="shrink-0 inline-flex items-center gap-1 px-4 py-2 rounded-lg text-xs font-normal bg-accent text-white hover:bg-accent-hover transition-colors"
      >
        네이버 비즈니스 스쿨 바로가기
