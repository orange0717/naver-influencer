...
export default function ScrollToTopButton() {
  ...
  return (
    <button
      ...
      aria-label="맨 위로"
      title="맨 위로"
      className="fixed right-6 z-50 flex flex-col items-center justify-center cursor-pointer transition-all focus:outline-none focus:ring-2 focus:ring-accent/40 bg-surface text-text-2 border border-border shadow-md"
      style={{
        bottom: '84px',
        width: '48px',
        height: '48px',
