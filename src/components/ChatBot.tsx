  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 w-14 h-14 bg-accent text-white rounded-full shadow-lg hover:bg-accent-hover transition-all z-50 flex items-center justify-center cursor-pointer"
        aria-label="고객센터"
      >
        {open ? (
