    ...
    <div className="flex flex-col gap-8">
      ...
      >
        <div className="flex items-center gap-2 overflow-x-auto scrollbar-hide">
          ...
          >
            <svg width="14" height="14" viewBox="0 0 24 24" fill={visibleFavorites.length > 0 ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth="2" aria-hidden="true" className={visibleFavorites.length > 0 ? 'text-accent' : ''}>
              <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z" />
            </svg>
            즐겨찾기
            <span className="text-[11px] font-bold text-dim">{visibleFavorites.length}</span>
          </button>
