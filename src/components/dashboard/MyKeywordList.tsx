            ...
            <table className="w-full">
              <thead>
                <tr className="text-xs text-dim border-b border-border/50 bg-bg/30">
                  ...
                  <th className="text-center px-2 py-2.5 font-semibold text-green-500/70">통합검색</th>
                  <th className="text-center px-2 py-2.5 font-semibold text-blue-500/70">블로그탭</th>
